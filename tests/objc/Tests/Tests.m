...
- (void) testType{
	...
	Class *sup = [Type getSuperClass:MKMapView];
	
	NSMutableString *sups = [Type getClassName:MKMapView];
	
	Class *cl = [Type resolveClass:@"objc.ios.map.MKMapView"];
}
- (void) testXml{
}
- (void) testTimer{
	...
	[Timer measure:@selector(testTimer) pos:[NSDictionary dictionaryWithObjects:[NSArray arrayWithObjects:@"Tests.hx",@"338",@"Tests",@"testTimer",nil] forKeys:[NSArray arrayWithObjects:@"fileName",@"lineNumber",@"className",@"methodName",nil]]];
	float f = [Timer stamp];
}
...
- (void) printHello{
	[Log trace:@"Hello from Haxe Objective-C" infos:[NSDictionary dictionaryWithObjects:[NSArray arrayWithObjects:@"Tests.hx",@"384",@"Tests",@"printHello",nil] forKeys:[NSArray arrayWithObjects:@"fileName",@"lineNumber",@"className",@"methodName",nil]]];
}
- (id) new{
	self = [super init];
	self.s = @"str";
