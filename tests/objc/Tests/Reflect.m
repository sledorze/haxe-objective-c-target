...
+ (BOOL) isFunction:(id)f{
	return f != nil && [f __GetType] == __global__FA_TAnon_ -GFA2-vtFunction;
}
...
+ (BOOL) isObject:(id)v{
	if (v == nil) return NO;
	int t = [v __GetType];
	return t == __global__FA_TAnon_ -GFA2-vtObject || t == __global__FA_TAnon_ -GFA2-vtClass || t == __global__FA_TAnon_ -GFA2-vtString || t == __global__FA_TAnon_ -GFA2-vtArray;
}
+ (BOOL) deleteField:(id)o f:(NSMutableString*)f{
	if (o == nil) return NO;
	return [__global__FA_TAnon_ -GFA2-__hxcpp_anon_remove:o :f];
}
+ (id) copy:(id)o{
	if (o == nil) return nil;
