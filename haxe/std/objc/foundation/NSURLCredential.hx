...
extern class NSURLCredential, implements NSCoding, implements NSCopying
{
	...
	public  function credentialWithIdentity( identity:SecIdentityRef,  certArray:NSArray,  persistence:NSURLCredentialPersistence):NSURLCredential;
	...
	public  function certificates():NSArray;
	public  function identity():SecIdentityRef;
	public  function user():String;
	public  function password():String;
	public  function initWithIdentity( identity:SecIdentityRef,  certArray:NSArray,  persistence:NSURLCredentialPersistence):Dynamic;
