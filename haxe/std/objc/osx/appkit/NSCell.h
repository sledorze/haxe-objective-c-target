 ...
 */
- (BOOL)truncatesLastVisibleLine NS_AVAILABLE_MAC(10_5);
- (void)setTruncatesLastVisibleLine:(BOOL)flag NS_AVAILABLE_MAC(10_5);
 ...
 */
- (BOOL)usesSingleLineMode NS_AVAILABLE_MAC(10_6);
- (void)setUsesSingleLineMode:(BOOL)flag NS_AVAILABLE_MAC(10_6);
 ...
 */
- (NSBackgroundStyle)backgroundStyle NS_AVAILABLE_MAC(10_5);
- (void)setBackgroundStyle:(NSBackgroundStyle)style NS_AVAILABLE_MAC(10_5);
