 ...
 * Animatable. */
	...
	public var  CFTimeInterval instanceDelay;
 ...
 * change). Animatable. */
	...
	public var  float instanceRedOffset, instanceGreenOffset;
	public var  float instanceBlueOffset, instanceAlphaOffset;
