 ...
 * into the CG context 'ctx'. */
	...
	@:require(ios_5_0) public static function contextWithOptions (dict:NSDictionary) :CIContext;
 ...
 * will draw directly though the context. */
	@:require(ios_5_0) public static function contextWithEAGLContext (eaglContext:EAGLContext) :CIContext;
	@:require(ios_5_0) public static function contextWithEAGLContext (eaglContext:EAGLContext, options:NSDictionary) :CIContext;
...
/* Render 'image' into a CVPixelBuffer using the context. */
	@:require(ios_5_0) public function render (image:CIImage, toCVPixelBuffer:CVPixelBufferRef) :Void;
	@:require(ios_5_0) public function render (image:CIImage, toCVPixelBuffer:CVPixelBufferRef, bounds:CGRect, colorSpace:CGColorSpaceRef) :Void;
 ...
 * on the currect context. */
	@:require(ios_5_0) public function inputImageMaximumSize () :CGSize;

/* Returns the maximum dimension for image that can be rendered 
 * on the currect context. */
	@:require(ios_5_0) public function outputImageMaximumSize () :CGSize;
