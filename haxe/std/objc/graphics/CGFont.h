...
/* Return the CFTypeID for CGFontRefs. */
	...
	@:c public static function CFTypeID CGFontGetTypeID(void)
...
/* Create a CGFontRef using `platformFontReference', a pointer to a
   ...
   should be a pointer to an ATSFontRef. */
	...
	@:c public static function CGFontRef CGFontCreateWithPlatformFont(void *platformFontReference)
...
/* Return the font defined by the data provided by `provider', or NULL if
   the font can't be created. */
	...
	@:c public static function CGFontRef CGFontCreateWithDataProvider(CGDataProviderRef provider)
