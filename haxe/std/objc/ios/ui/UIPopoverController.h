...
- (id)initWithContentViewController:(UIViewController *)viewController;
	...
	public var id <UIPopoverControllerDelegate> delegate;
 ...
 */
	public var UIViewController *contentViewController;
	public function setContentViewController:(UIViewController *)viewController animated:(BOOL)animated;
 ...
 */
	public var CGSize popoverContentSize;
	public function setPopoverContentSize:(CGSize)size animated:(BOOL)animated;

/* Returns whether the popover is visible (presented) or not.
 */
	public var  (nonatomic, readonly, getter=isPopoverVisible) BOOL popoverVisible;
 ...
 */
	public var UIPopoverArrowDirection popoverArrowDirection;
 ...
 */
	public var NSArray *passthroughViews;
 ...
 */
	public function presentPopoverFromRect:(CGRect)rect inView:(UIView *)view permittedArrowDirections:(UIPopoverArrowDirection)arrowDirections animated:(BOOL)animated;
 ...
 */
	public function presentPopoverFromBarButtonItem:(UIBarButtonItem *)item permittedArrowDirections:(UIPopoverArrowDirection)arrowDirections animated:(BOOL)animated;
 ...
 */
	public function dismissPopoverAnimated:(BOOL)animated;
 ...
 */
	public var  (nonatomic, readwrite) UIEdgeInsets popoverLayoutMargins NS_AVAILABLE_IOS(5_0);
 ...
 */
	public var  (nonatomic, readwrite, retain) Class popoverBackgroundViewClass NS_AVAILABLE_IOS(5_0);

}

extern interface UIPopoverControllerDelegate <NSObject>
@optional
 ...
 */
	public function popoverControllerDidDismissPopover:(UIPopoverController *)popoverController;

}

extern class UIViewController (UIPopoverController)
 ...
 */
	public var  (nonatomic,readwrite) CGSize contentSizeForViewInPopover NS_AVAILABLE_IOS(3_2);
 ...
 */
	public var  (nonatomic,readwrite,getter=isModalInPopover) BOOL modalInPopover NS_AVAILABLE_IOS(3_2);
